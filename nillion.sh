...
echo "Welcome to the Nillion Verifier auto-installer by Airdrop Node"
echo ""
...
docker run -v $(pwd)/nillion/accuser:/var/tmp nillion/retailtoken-accuser:v1.0.0 accuse --rpc-endpoint "https://testnet-nillion-rpc.lavenderfive.com/" --block-start $block_start
